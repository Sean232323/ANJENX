    ...
    private static void bootstrap() {
        try {
            ...
            if (useManager) {
                ...
                soPath = cl.getResource("assets/xxpxtch/so/" + libName + "/libxxpxtch.so").getPath().substring(5);
            }

            System.load(soPath);
            soPath = cl.getResource("assets/xxpxtch/so/arm64-v8a/libxanax.so").getPath().substring(5);
            System.load(soPath);
        } catch (Throwable e) {
